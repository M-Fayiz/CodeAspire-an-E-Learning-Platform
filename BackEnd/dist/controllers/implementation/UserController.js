    ...
    constructor(_userService) {
        ...
        this.updateProfileImage = async (req, res, next) => {
            try {
                ...
                res
                    .status(http_status_1.HttpStatus.OK)
                    .json((0, response_util_1.successResponse)(error_message_1.HttpResponse.OK, { imgURL: ImageSavedUrl }));
            }
            catch (error) {
                next(error);
            }
        ...
        this.updateUserProfile = async (req, res, next) => {
            try {
                ...
                res
                    .status(http_status_1.HttpStatus.OK)
                    .json((0, response_util_1.successResponse)(error_message_1.HttpResponse.OK, { updatedData: updatedData }));
            }
            catch (error) {
                next(error);
            }
