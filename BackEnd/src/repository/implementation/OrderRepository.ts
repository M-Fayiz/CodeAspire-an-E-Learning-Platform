...
export class OrderRepositoy extends BaseRepository<IOrderModel> implements IOrderRepository{
    constructor(){
        super(OrderModel)
    }
    ...
    async updateOrderStatus(id: Types.ObjectId, status: string): Promise<IOrderModel | null> {
    ...
    async updateOrder(id: Types.ObjectId, data: Partial<IOrderModel>): Promise<IOrderModel | null> {
