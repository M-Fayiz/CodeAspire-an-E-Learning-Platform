...
const MentorDashboard = () => {
  ...
  const [mentorDashData,setMentorDashData]=useState<IMentorDhasboardDTO|null>(null)
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard
            ...
            title="Total Revenue"
            value={mentorDashData?.revanue ?mentorDashData?.revanue as number:0}
            bgColor="bg-gradient-to-br from-orange-400 to-orange-600"
          />
          <StatCard
            Icon={<Star className="w-5 h-5 text-white"/>}
            title="Average Rating"
            value={mentorDashData?.summary.avgRating ?mentorDashData?.summary.avgRating as number:0 }
          ...
          <StatCard
            ...
            title="Total Student"
            value={mentorDashData?.summary.totalStudents ?mentorDashData?.summary.totalStudents as number:0}
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                {mentorDashData?.topCourse.map((course, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center text-white font-semibold  bg-gray-300`}>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">Your Earnings</h3>
