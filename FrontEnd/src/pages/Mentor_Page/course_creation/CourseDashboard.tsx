...
import { Eye, IndianRupee, LayoutDashboard, MessageSquare, TrendingUp, Users } from "lucide-react";
...
const CourseDashboard = () => {
  ...
  const content = {
    stats: [
      { label: "Total Learners", value: dashboardData?.enrolledStudents, icon: Users },
      {
        label: "Total Revenue",
        value: dashboardData?.revenue.mentor,
        icon: IndianRupee,
      },
      { label: "Total Courses", value: Math.floor(dashboardData?.avgRating as number), icon: TrendingUp },
    ],
  };
      ...
      <div className="bg-white rounded-xl shadow-md p-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <select
              className="border rounded-md px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-300"
            >
              <option>Today</option>
