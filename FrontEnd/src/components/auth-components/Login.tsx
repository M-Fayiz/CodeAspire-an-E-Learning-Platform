    ...
    <div>
      ...
      <div>
        <div className="flex flex-col lg:flex-row">
          <div
            className={`lg:w-1/2 ${currentRole.color} p-5 flex flex-col justify-evenly items-center  text-white relative`}
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-blue-800 dark:text-sky-600/100 text-3xl font-bold mb-2">
                Welcome Back!
              </h2>
