...
const MentorInfoForm: React.FC = () => {
  ...
  const handleInputChange = (section: keyof MentorFormData, field: string, value: string) => {
    setFormData(prev => ({
      ...prev,
      [section]: {
        ...prev[section],
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white">
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Mentor Registration</h1>
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <Github className="absolute left-3 top-2.5 text-gray-400" size={16} />
                <input
                  type="url"
